...
angular.module('authoringEnvironmentApp').controller(
    'ImageUploadingCtrl',
    ['$scope', 'imageUploading', '$upload', 'imageResource', 'configuration', 'getFileReader', 'transform', '$log',
     function ($scope, imageUploading, $upload, imageResource, configuration, getFileReader, transform, $log) {
