define(['aloha', 'aloha/plugin', 'jquery',  'jquery19', 'aloha/console', 'aloha/ephemera', 'block/block', 'block/blockmanager'], 
        function(Aloha, Plugin, jQuery,  jQuery19, Console, Ephemera, block, BlockManager) {
