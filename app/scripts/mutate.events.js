...
var mutate_event_stack = [
    {
        name: 'width',
        handler: function (elem) {
            var n = {el:elem};
            if (!$(n.el).data('mutate-width')) {
    ...
    },
    {
        ...
        handler: function (n) {
            var element = n;
            if (!$(element).data('mutate-height')) {
                $(element).data('mutate-height', $(element).height());
            }
            if ($(element).data('mutate-height') &&
                $(element).height() !== $(element).data('mutate-height')
            ) {
                $(element).data('mutate-height', $(element).height());
                return true;
            }
    ...
    },
    {
        ...
        handler: function (n) {
            ...
            if ($(n).data('mutate-bottom') &&
                $(n).css('bottom') !== $(n).data('mutate-bottom')
            ) {
                $(n).data('mutate-bottom', $(n).css('bottom'));
                return true;
            }
    ...
    },
    {
        ...
        handler: function (n) {
            ...
            if ($(n).data('mutate-right') &&
                $(n).css('right') !== $(n).data('mutate-right')
            ) {
                $(n).data('mutate-right', $(n).css('right'));
                return true;
            }
    ...
    },
    {
        ...
        handler: function (n) {
            ...
            if ($(n).data('prev-scrollHeight') &&
                $(n)[0].scrollHeight !== $(n).data('prev-scrollHeight')
            ) {
                $(n).data('prev-scrollHeight', $(n)[0].scrollHeight);
                return true;
            }
    ...
    },
    {
        ...
        handler: function (n) {
            ...
            if ($(n).data('prev-scrollWidth') &&
                $(n)[0].scrollWidth !== $(n).data('prev-scrollWidth')
            ) {
                $(n).data('prev-scrollWidth', $(n)[0].scrollWidth);
                return true;
            }
    ...
    },
    {
        ...
        handler: function (n) {
            ...
            if ($(n).data('prev-scrollTop') &&
                $(n)[0].scrollTop() !== $(n).data('prev-scrollTop')
            ) {
                $(n).data('prev-scrollTop', $(n)[0].scrollTop());
                return true;
            }
    ...
    },
    {
        ...
        handler: function (n) {
            ...
            if ($(n).data('prev-scrollLeft') &&
                $(n)[0].scrollLeft() !== $(n).data('prev-scrollLeft')
            ) {
                $(n).data('prev-scrollLeft', $(n)[0].scrollLeft());
                return true;
            }
